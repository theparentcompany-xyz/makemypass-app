  ...
  return (
    <Theme>
      <div className={styles.contentContainer}>
        ...
        <p>
          MakeMyPass is a platform designed for creating and managing events. Users can register for
          events, and event creators can access and share registrant data with authorized personnel.
        </p>
        ...
        <p>
          ...
          damages, or impairs the service. You agree not to attempt to gain unauthorized access to
          any part of the Service or to any other accounts, computer systems, or networks connected
          to the Service.
        </p>

        <h4>6. Content Ownership and Intellectual Property</h4>
        <p>
          You retain all your ownership rights to the content you submit, post, or display on or
        ...
        <p>
          The Service is provided on an "AS IS" and "AS AVAILABLE" basis. We do not warrant the
          accuracy, completeness, or usefulness of this service. In no event shall we be liable for
          any damages arising out of the use or inability to use the Service.
        </p>
