    ...
    return (
        <Theme>
            <div className={styles.contentContainer}>
                ...
                <p>
                    Welcome to MakeMyPass (the "Service"), operated by [Your
                    Company Name] (referred to as "us", "we", or "our"). Our
                    website is available at
                    <a href="http://makemypass.com">makemypass.com</a>. This
                    Terms of Service agreement governs your use of our Service.
                </p>

                <h4>2. Use of Service</h4>
                <p>
                    MakeMyPass is a platform designed for creating and managing
                    events. Users can register for events, and event creators
                    can access and share registrant data with authorized
                    personnel.
                </p>
                ...
                <p>
                    ...
                    available on our website, explains how we collect, use, and
                ...
                <p>
                    ...
                    part of the Service or to any other accounts, computer
                    systems, or networks connected to the Service.
                </p>

                <h4>6. Content Ownership and Intellectual Property</h4>
                <p>
                    You retain all your ownership rights to the content you
                    submit, post, or display on or through the Service. By
                    submitting content, you grant us a worldwide, non-exclusive,
                    royalty-free license to use, copy, reproduce, process,
                ...
                <p>
                    ...
                    usefulness of this service. In no event shall we be liable
                ...
                <p>
                    ...
                    replace these Terms at any time. We will provide at least
                    [number] days' notice prior to any new terms taking effect.
                </p>
