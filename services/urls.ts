...
export const makeMyPass = {
  ...
  eventVenueUpdate: (eventId: string) => makeMyPassURL(`/manage-event/${eventId}/venue/update`),
  ...
  spinWheelLogList: (eventId: string) => makeMyPassURL(`/games/${eventId}/spinwheel/log/list`),
};
